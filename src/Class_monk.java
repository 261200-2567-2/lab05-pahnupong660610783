...
public class Class_monk implements Characters {
    private  String name;
    ...
    public Class_monk(String name , int level) {
        this.name = name;
        this.classStats = new Stats(100,50,30,20,12);
    ...
    public void levelUp() {
        ...
        classStats.addStats(new Stats(50,20,5,5,1));
