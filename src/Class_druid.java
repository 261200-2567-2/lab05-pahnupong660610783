...
public class Class_druid implements  Characters{
    private  String name;
    ...
    public Class_druid(String name , int level) {
        this.name = name;
        this.classStats = new Stats(150,100,20,20,8);
    ...
    public void levelUp() {
        ...
        classStats.addStats(new Stats(65,50,2,2,0));
