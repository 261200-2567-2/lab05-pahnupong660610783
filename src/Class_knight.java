...
public class Class_knight implements Characters {
    private  String name;
    ...
    public Class_knight(String name , int level) {
        this.name = name;
        this.classStats = new Stats(130,20,15,30,8);
    ...
    public void levelUp() {
        ...
        classStats.addStats(new Stats(60,15,3,7,0));
